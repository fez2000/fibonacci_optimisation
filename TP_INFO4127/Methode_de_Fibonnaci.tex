...
\title{
    \horrule{0.5pt} \\ [0.4cm]
    \Huge Exposé Groupe 11 INFO 4127 TECHNIQUE D'OPTIMISATION\\ THÈME: \\ MÉTHODE DES SUITES DE FIBONACCI\\
    \horrule{2pt} \\[0.5cm]
\begin{center}
...
\end{center}
    ...
    \normalfont \normalsize \textsc{Filière: INFORMATIQUE FONDAMENTALE\\Option: Data Science} \\ [20pt]
 }
\author{
    \normalfont Documents rédige par les étudiants:\\\\                                
